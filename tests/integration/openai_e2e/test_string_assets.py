...
Requirements:
- The agreement should be exactly 3000 words. Not longer, not shorter. The words counter will be performed using len(text.split()) in Python.
- The agreement must include a section that forbids an employee from working for killing tigers in Siberia.
